...
type IDeveloperService interface {
	...
	FindOrCreateDevelopers(ctx context.Context, developers []*entity.Developer) (error, int64)

	CreateDevelopers(ctx context.Context, developers []*entity.Developer) error
