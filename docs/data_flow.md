...
%%    
    ...
    Note left of Registry Service: Starting inspection pool
    Inspection Service ->> Registry Services: Inspect every package
%% 
...
%% 
    ...
    Inspection Service ->> Inspection Service: Analyse duplications, prepare payloads
    Note right of Inspection Service: Starting GitHub inspection pool
    Inspection Service ->> Github Service: Search developers, repositories
    activate Github Service
    Github Service ->> Github Service: Load repository metadata
    Github Service ->> Github Service: Load repository users
    Github Service ->> Github Service: Inspect latest commits
    Github Service ->> Github Service: Inspect latest issues
